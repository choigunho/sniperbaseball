...
$qeury_ERA = "SELECT * FROM af372.currentseasonpitchingstats order by ERA DESC limit 1;";
...
echo "<li class='list-group-item'><img src='img/".$row_WIN[id].".jpg' style='width: 15%; float: left; margin-right: 10%;' alt='...'><div><small>Wins</small></div><div><b>".$row_WIN[LAST_NM_EN]." ".$row_WIN[FIRST_NM_EN]."</b><span class='badge' style='float: right'>".$row_WIN[W]."</span></div><div>".$row_WIN[POSITION]."</div></li>";
        echo "<li class='list-group-item'><img src='img/".$row_ERA[id].".jpg' style='width: 15%; float: left; margin-right: 10%;' alt='...'><div><small>Earned Run Average</small></div><div><b>".$row_ERA[LAST_NM_EN]." ".$row_ERA[FIRST_NM_EN]."</b><span class='badge' style='float: right'>".$row_ERA[ERA]."</span></div><div>".$row_ERA[POSITION]."</div></li>";
